    ...
    return (
        <aside className="w-64 h-screen bg-gray-800 text-white flex flex-col p-4">
            ...
            <nav className="w-[109%] h-screen flex flex-col space-y-10 mt-4">
                ...
                <NavLink className={({ isActive }) => isActive ? "flex items-center bg-gray-500 font-bold pl-2 rounded-l-[10px] h-16" : ""} to="posts">Posts</NavLink>
                <NavLink className={({ isActive }) => isActive ? "flex items-center bg-gray-500 font-bold pl-2 rounded-l-[10px] h-16" : ""} to="createpost">Create Post</NavLink>
                <NavLink className={({ isActive }) => isActive ? "flex items-center bg-gray-500 font-bold pl-2 rounded-l-[10px] h-16" : ""} to="createcategory">Create Category</NavLink>
